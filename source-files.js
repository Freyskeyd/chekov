...
sourcesIndex["chekov"] = {"name":"","dirs":[{"name":"aggregate","dirs":[{"name":"instance","files":["internal.rs","runtime.rs"]}],"files":["instance.rs","mod.rs","registry.rs","resolver.rs"]},{"name":"application","files":["builder.rs","internal.rs","mod.rs"]},{"name":"command","dirs":[{"name":"handler","files":["instance.rs","registry.rs"]}],"files":["consistency.rs","handler.rs","metadata.rs","mod.rs"]},{"name":"event","files":["handler.rs","mod.rs","resolver.rs"]},{"name":"subscriber","files":["listener.rs","manager.rs","mod.rs","subscriber.rs"]}],"files":["error.rs","event_store.rs","lib.rs","message.rs","prelude.rs","router.rs"]};
